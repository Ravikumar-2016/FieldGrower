...
<div class="center-container">
    <!-- Main button "Crops" with dropdown on hover -->
    <div class="main-button">
        Crops
        <div class="submenu">
            <a href="3aviewcropdetails.php">Crop Details</a>
            <a href="3baddnewcrop.php">Add New Crop</a>
            <a href="3cremovecrop.php">Remove Existing Crop</a>
            <a href="3dfertilizers.php">Fertilizers</a>
            <a href="3epesticides.php">Pesticides</a>
        </div>
    </div>
    
    <!-- Other main buttons -->
    <button class="main-button" onclick="location.href='3fmarket.php'">Market</button>
    <div class="main-button">
        WorkFarm
        <div class="submenu">
            <a href="3gaddnewwork.php">Add New Work</a>
            <a href="3hviewpastworks.php">View Past Works</a>
            <a href="3iupdatesonworks.php">Updates On Works</a>
        </div>
</div>
