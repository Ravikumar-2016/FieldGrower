...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($check_employee_result->num_rows === 0) {
            ...
            $update_salary_sql = "UPDATE employee SET salary = '$new_salary' WHERE username = '$username'";
            if ($conn->query($update_salary_sql)) {
                $message = "Salary updated successfully for employee '$username'.";
            } else {
...
<body>
    <h1 style="text-align: center;">Update Employee Salary</h1>
